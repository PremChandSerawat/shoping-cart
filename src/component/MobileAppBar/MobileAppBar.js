...
class PrimarySearchAppBar extends React.Component {
  ...
  componentDidMount() {
    console.log("props to state",this.props);
...
add=()=>{
  ...
  handleSideDrawer=()=>{
    ...
    this.setState(state=>({isSideDrawerOpen:!state.isSideDrawerOpen}))
  ...
  render() {
   ...
   const renderMobileMenu = (
    ...
    return (
     ...
     <Drawer
       onBackdropClick={this.handleSideDrawer}
          ...
          <div className={classes.root}>
            <AppBar position="static">
              <Toolbar>
                ...
                <div className={classes.cart} onClick={this.add}>
                  <IconButton  color="inherit">
                   <Badge badgeContent={this.props.addToCart.totalItem} color="secondary">
                    <Icon>
...
const mapStateToProps=(state)=>{
  ...
  return {
   ...
   addreshReducer:state.addreshReducer,
 }
}
